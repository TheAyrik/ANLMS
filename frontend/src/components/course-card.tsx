  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 flex-col gap-4 px-6 py-6">
        <div className="flex items-center gap-2 text-sm text-pardis-primary-700">
          <span className={clsx('size-2 rounded-full', accentTone.dot)} />
          <span className="font-semibold">{status}</span>
        </div>
        <div>
          <p className="text-xl font-extrabold tracking-tight text-gray-950">{title}</p>
        ...
        <div className="mt-auto flex items-center justify-between gap-3 pt-2 text-sm font-semibold text-gray-700">
          <span className="inline-flex items-center gap-2 rounded-xl bg-gray-50 px-3 py-2 ring-1 ring-gray-200">
            <UserGroupIcon className="size-4 text-pardis-primary-700" />
